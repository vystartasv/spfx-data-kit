export const capabilityManifest = {
  ...
  status: {
    ...
    graphSharingPermissions: "partial",
    graphSearch: "partial",
    graphResumableUploadsThumbnailsPreviews: "planned",
    graphAdminProvisioningPagesNavigationProfilesSearchTaxonomy: "planned",
    graphAdminProvisioningPagesNavigationProfilesTaxonomy: "planned",
