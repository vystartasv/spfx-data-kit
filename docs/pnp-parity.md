...
| Graph mail, calendar, Teams, Planner, To Do, admin, provisioning, pages, navigation, profiles, search, taxonomy, and other service families | present across selected modules | present across selected modules | planned | Not implemented or claimed in this track; add only as independently specified typed REST surfaces. |
