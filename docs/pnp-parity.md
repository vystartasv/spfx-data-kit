...
| Files, drives, sites, groups, admin, and other service families | present across selected modules | present across selected modules | planned | Add only as independently specified typed REST surfaces. |
